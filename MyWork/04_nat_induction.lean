...
/-
Start with baseSq = 0 for n = 0
Apply stepSq:
- For n = 0: stepSq 0 0 = 0^2 + 0 = 0
- For n = 1: stepSq 1 1 = 1^2 + 0 = 1
- For n = 2: stepSq 2 1 = 2^2 + 1 = 5
- For n = 3: stepSq 3 5 = 3^2 + 5 = 14
-/
...
#eval sumSq' 6  -- expect 91
#eval sumSq' 10 -- expect 385

-- Additional test: compare with manual calculation
#eval sumSq' 7 == (1^2 + 2^2 + 3^2 + 4^2 + 5^2 + 6^2 + 7^2)  -- expect true

-- Edge case: large number
#eval sumSq' 100  -- expect 338350
